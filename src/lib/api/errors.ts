...
export const ErrorCodes = {
  ...
  SESSION_NOT_INDEXED: 'SESSION_NOT_INDEXED',
  CONTENT_NOT_FOUND: 'CONTENT_NOT_FOUND',
  CHAT_MESSAGE_NOT_FOUND: 'CHAT_MESSAGE_NOT_FOUND',
  CHAT_STREAM_EXPIRED: 'CHAT_STREAM_EXPIRED',
  WORKSPACE_NOT_FOUND: 'WORKSPACE_NOT_FOUND',
  TOOL_NOT_FOUND: 'TOOL_NOT_FOUND',
  INDEXING_TIMEOUT: 'INDEXING_TIMEOUT',
  CLAUDE_MPM_NOT_AVAILABLE: 'CLAUDE_MPM_NOT_AVAILABLE',
  CLAUDE_MPM_TIMEOUT: 'CLAUDE_MPM_TIMEOUT',
