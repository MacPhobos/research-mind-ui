...
<style>
  ...
  /* Sources/References section styling (deprecated)
   * Kept for backward compatibility with old persisted messages.
   * New answers no longer produce a Sources section (inline citations only).
   * Styling is intentionally minimal so old messages render subtly. */
